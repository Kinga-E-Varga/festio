 ...
 */
const BUTTON =
  'inline-flex items-center justify-center gap-2 px-5 py-3 text-[12px] font-semibold tracking-[0.16em] uppercase transition-all duration-200 rounded-sm border-1 disabled:cursor-not-allowed disabled:opacity-40'
...
export const TOGGLE_SOLID = `${BUTTON} border-[var(--c3)] bg-[var(--c3)] text-[color:var(--c1)] hover:opacity-60`
 ...
 */
export const PANEL = 'w-[clamp(400px,33.333vw,700px)] shrink-0'
